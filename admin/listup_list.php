...
$sql="select * from `g5_write_main` where wr_6= 'Y' and wr_is_comment = 0 and wr_file != 0 order by `wr_1` asc limit {$start},{$rows}";
...
$sqlY="select * from `g5_write_main` where wr_6= 'W' and wr_is_comment = 0 and wr_file != 0 order by `wr_1` asc  limit {$start},{$rows}";
