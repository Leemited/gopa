                        ...
                        <tr>
                            ...
                            <td>
                                <div style="position: relative;">
                                    ...
                                    <div style="width:100%;background:#ddd; transition: all .2s ease-in-out;text-align: center;padding:5px 0;" onclick="fnYear('<?=$wr_id?>','<?=$year?>')"><?php echo $list[$i]["total"]?> 원</div>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
