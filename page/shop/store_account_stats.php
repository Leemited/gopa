...
<div class="width-fixed mt_b_30">
    ...
    <section class="section01">
        <div class="search">
            <form action="<?php echo G5_URL?>/page/shop/store_order_stats.php" method="post" name="search">
                <div class="search_input">
                    <input type="hidden"  class="input01" value="<?=$day?>" id="datepickers" name="day" onchange="fnStats(this.value, '<?php echo $wr_id ;?>')">
        ...
        <div class="stats_con">
            ...
            <div class="total">
                총 주 문 : <span><?=number_format($total_price)?> 원</span>
...
<script>
    $(document).ready(function(){
        ...
        $("#datepicker").datepicker({
            ...
            onSelect:function(){
                var date = $(this).val();
                location.href=g5_url+'/page/shop/store_account_stats.php?day='+date+"&wr_id="+<?=$wr_id?>;
            }
        });
    })
