		...
		<div class="section01_content wrap">
			<div class="view01">
				<header>
					...
					<p>
						기간 : <?php echo date("Y.m.d",strtotime($view['wr_1'])) ?> ~ <?php echo date("Y.m.d",strtotime($view['wr_2'])) ?><br />
						<!-- <?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<?php echo date("Y.m.d", strtotime($view['wr_datetime'])) ?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;조회:&nbsp;<?php echo number_format($view['wr_hit']) ?> -->
					</p>
				</header>
				<?php
				if ($view['file']['count']) {
